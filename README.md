...
- [x] Make the added DeleteMovieModal appear and be reacted to before deletion occurs.
...
- [x] For extra credit, ensure that only unique movies can be added as favorites. Consider the `.find` method for arrays.
- Add in some Style!
